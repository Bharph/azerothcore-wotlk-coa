...
bool PlayerbotAIConfig::Initialize()
{
    ...
    lfgMaxLevelGap = sConfigMgr->GetOption<int32>("AiPlayerbot.LfgMaxLevelGap", 5);
    ...
    zoneChannelId = sConfigMgr->GetOption<uint32>("AiPlayerbot.ZoneChannelId", uint32(ChatChannelId::GENERAL));
